    ...
    "Basics": [
        {
            ...
            "answer": ['2025-03-03T14:31', '2025-03-03T14:32', '2025-03-03T14:33'],
            "explanation": "Simple every minute"
        },
        {
            "input": ["*/15 * * * *", "2025-03-03T14:30"],
            "answer": ['2025-03-03T14:45', '2025-03-03T15:00', '2025-03-03T15:15'],
            "explanation": "Every 15 minutes"
        },
        {
            "input": ["5,10,15,20 * * * *", "2025-03-03T14:07"],
            "answer": ['2025-03-03T14:10', '2025-03-03T14:15', '2025-03-03T14:20'],
            "explanation": "Specific minutes"
        },
        {
            "input": ["10-20 * * * *", "2025-03-03T14:05"],
            "answer": ['2025-03-03T14:10', '2025-03-03T14:11', '2025-03-03T14:12'],
            "explanation": "Range of minutes"
        },
        {
            "input": ["10-30/5 * * * *", "2025-03-03T14:12"],
            "answer": ['2025-03-03T14:15', '2025-03-03T14:20', '2025-03-03T14:25'],
            "explanation": "Range with step"
        },
        {
            "input": ["@daily", "2025-03-03T14:30"],
            "answer": ['2025-03-04T00:00', '2025-03-05T00:00', '2025-03-06T00:00'],
    ...
    "Extra": [
        {
            ...
            "answer": ['2025-03-04T05:00', '2025-03-05T05:00', '2025-03-06T05:00'],
            "explanation": "Specific hour"
        },
        {
            "input": ["30 * * * *", "2025-03-03T14:15"],
            "answer": ['2025-03-03T14:30', '2025-03-03T15:30', '2025-03-03T16:30'],
            "explanation": "Every hour at 30 minutes"
        },
        {
            "input": ["0 8-17 * * *", "2025-03-03T18:30"],
            "answer": ['2025-03-04T08:00', '2025-03-04T09:00', '2025-03-04T10:00'],
            "explanation": "Range of hours"
        },
        {
            "input": ["0 8-17/3 * * *", "2025-03-03T10:30"],
            "answer": ['2025-03-03T11:00', '2025-03-03T14:00', '2025-03-03T17:00'],
        ...
        },
        {
            ...
            "answer": ['2025-03-10T00:00', '2025-03-17T00:00', '2025-03-24T00:00'],
            "explanation": "Every Monday at midnight"
        },
        {
            "input": ["0 12 * * 0,6", "2025-03-03T14:30"],
            "answer": ['2025-03-08T12:00', '2025-03-09T12:00', '2025-03-15T12:00'],
            "explanation": "Every weekend (Saturday and Sunday)"
        },
        {
            "input": ["0 0 1 * *", "2025-03-03T14:30"],
            "answer": ['2025-04-01T00:00', '2025-05-01T00:00', '2025-06-01T00:00'],
            "explanation": "First day of every month"
        },
        {
            "input": ["0 0 29 2 *", "2024-01-15T10:00"],
            "answer": ['2024-02-29T00:00', '2028-02-29T00:00', '2032-02-29T00:00'],
            "explanation": "Last day of February (leap year 2024)"
        },
        {
            "input": ["0 0 29 2 *", "2025-01-15T10:00"],
            "answer": ['2028-02-29T00:00', '2032-02-29T00:00', '2036-02-29T00:00'],
            "explanation": "Last day of February (non-leap year 2025)"
        },
        {
            "input": ["0 0 1 * 1", "2025-03-03T14:30"],
            "answer": ['2025-09-01T00:00', '2025-12-01T00:00', '2026-06-01T00:00'],
        ...
        },
        {
            ...
            "answer": ['2025-03-03T00:30', '2025-03-03T03:30', '2025-03-03T06:30'],
            "explanation": "30 minutes past every 3rd hour on weekdays"
        },
        {
            "input": ["45 12 * * *", "2025-03-03T12:45"],
            "answer": ['2025-03-04T12:45', '2025-03-05T12:45', '2025-03-06T12:45'],
